...
public class GameGUI extends JFrame {
    ...
    private void showGameScreen() {
        ...
        gamePanel.add(timerLabel, BorderLayout.NORTH); // Add timer label at the top
        gamePanel.add(gameLetterLabel, BorderLayout.CENTER);
        gamePanel.add(new JScrollPane(scoresArea), BorderLayout.EAST); // Adjusted for better layout
